 ...
 */
@RestController
@RequestMapping("/component/component-type")
public class ComponentTypeController extends AbstractXController {

    public ComponentTypeController(HttpServletRequest httpServletRequest) {
