package com.ezlinker.app.modules.future.controller;
 ...
 */
@RestController
@RequestMapping("/future/future")
public class FutureController extends AbstractXController {

    public FutureController(HttpServletRequest httpServletRequest) {
